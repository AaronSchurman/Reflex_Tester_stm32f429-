...
// here I am defining the levels

#define LCD_LEVEL_1 1
#define LCD_LEVEL_2 2
#define LCD_LEVEL_3 3
...
// Display Each Level of the Game
void LCD_Display(uint8_t Level);

// Special Level Three display function for each part of animation
